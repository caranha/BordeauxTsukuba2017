require 'lib.EGS.GUIElements.GUIClassDecleration'
...
GUIGraphics = 	{
			["spotImg"] = love.graphics.newImage("lib/EGS/GUIUI/WhiteSpot.png"),
			["Check"] = love.graphics.newImage("lib/EGS/GUIUI/Check.png"),
				}
...
require("lib/EGS/GUIElements/CheckBox")
require("lib/EGS/GUIElements/TextButton")
require("lib/EGS/GUIElements/Slider")